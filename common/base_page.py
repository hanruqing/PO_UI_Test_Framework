...
class BasePage(object):
    ...
    #selenium执行js
    def __excute_script(self,js_str,element_info=None):
        if element_info:
    ...
    def delete_element_attribute(self,element_info,attribute_name):
        element=self.find_element(element_info)
        self.__excute_script('arguments[0].removeAttribute("%s");'%attribute_name,element)

    def delete_element_attribute(self,element_info,attribute_name):
        element=self.find_element(element_info)
        self.driver.excute_script('arguments[0].removeAttribute("%s");'%attribute_name,element)

    def update_element_attribute(self,element_info,attribute_name,attribute_value):
        element = self.find_element(element_info)
        self.driver.excute_script('arguments[0].setAttribute("%s");' % attribute_name, attribute_value)
    ...
    def switch_to_frame_by_id_or_name(self,id_or_name):
        self.driver.switch_to_frame(id_or_name)
    ...
    def switch_to_frame(self,**element_dict): #switch_to_frame(id=frameid)  element=element_info
        if 'id' in element_dict.keys():
            ...
            element=self.driver.switch_to_frame(element_dict['element'])
            self.driver.switch_to_frame(element)

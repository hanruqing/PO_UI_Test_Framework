...
class Browser(object):
    ...
    def __get_chrome_driver(self):
        ...
        chrome_options.add_experimental_option('useAutomationExtension',False)#取消chrome受自动化软件测试控制
        chrome_options.add_experimental_option('excludeSwitches',['enabe-automation'])
    ...
    def __get_edge_driver(self):
        ...
        driver = webdriver.Firefox(executable_path=edge_driver_path)
        return driver

    def __get_remote_driver(self):#selenium支持分布式 grid ==> 配置（自己代码编写，配置）
        pass
